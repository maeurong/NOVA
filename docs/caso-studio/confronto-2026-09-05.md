...
| voce | valore |
|---|---|
| commit NOVA (codice che ha prodotto questi export) | `6e47896` |
| run telaio | `adedd4d0b9bf` |
| run solido | `b2389686c87b` |
...
| data corsa | 2026-09-12T10:09:43 |
...
|---|---|---|---|---|---|---|
| reazione_x [N] | C1 | 0 | 0,00001705 | — | non_confrontabile | entrambi i valori sotto il pavimento di rumore per «N» (< 0,01000) |
| reazione_z [N] | C1 | 7545 | 4249 | 77,60 % | lontano | — |
| u_sommita_x [mm] | C1 | 0 [^zero] | −0,001161 | — | non_confrontabile | il telaio vale 0 mm, sotto il pavimento (< 0,0001000); il riferimento −0,001161: i due non concordano, la percentuale non è un numero utile |
| u_sommita_z [mm] | C1 | −0,002077 | −0,02101 | 90,11 % | lontano | — |
| reazione_x [N] | C2 | −754,5 | −0,00001480 | — | non_confrontabile | il riferimento vale −0,00001480 N, sotto il pavimento (< 0,01000); il telaio −754,5: i due non concordano, la percentuale non è un numero utile |
...
| reazione_x [N] | C3 | 0 | −0,00001648 | — | non_confrontabile | entrambi i valori sotto il pavimento di rumore per «N» (< 0,01000) |
| reazione_z [N] | C3 | 8745 | 5449 | 60,51 % | lontano | — |
| u_sommita_x [mm] | C3 | 0 [^zero] | −0,001515 | — | non_confrontabile | il telaio vale 0 mm, sotto il pavimento (< 0,0001000); il riferimento −0,001515: i due non concordano, la percentuale non è un numero utile |
| u_sommita_z [mm] | C3 | −0,003021 | −0,03291 | 90,82 % | lontano | — |
| taglio_base [N] | C2 | −754,5 | −0,00001480 | — | non_confrontabile | il riferimento vale −0,00001480 N, sotto il pavimento (< 0,01000); il telaio −754,5: i due non concordano, la percentuale non è un numero utile |
