# UFF Data Set 58 — Function at Nodal DOF (UC-SDRL)

**URL** https://www.ceas3.uc.edu/sdrluff/files/58.asc
**Catturato** 2026-09-08 · **strumento** curl 8.7.1

Specifica del data set 58 del Universal File Format, pubblicata dal Structural Dynamics Research
Laboratory della University of Cincinnati. E' il formato delle **funzioni** misurate (FRF, spettri,
storie temporali) e, con i tipi 22 e 23, di autovalori e autovettori.
