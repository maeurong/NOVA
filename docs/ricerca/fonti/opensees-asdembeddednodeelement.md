# OpenSees Documentation - ASDEmbeddedNode Element (sorgente reStructuredText)

Fonte: https://raw.githubusercontent.com/OpenSees/OpenSeesDocumentation/master/source/user/manual/model/elements/ASDEmbeddedNodeElement.rst
