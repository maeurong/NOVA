# UFF Data Set 55 — Data at Nodes (UC-SDRL)

**URL** https://www.ceas3.uc.edu/sdrluff/files/55.asc
**Catturato** 2026-09-08 · **strumento** curl 8.7.1

Specifica del data set 55 del Universal File Format, pubblicata dal Structural Dynamics Research
Laboratory della University of Cincinnati. E' il formato con cui i programmi di analisi modale
esportano i risultati modali (frequenza, massa modale, smorzamento, forma ai nodi).
