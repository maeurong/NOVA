# OpenSees Documentation - SSPbrick Element (sorgente reStructuredText)

Fonte: https://raw.githubusercontent.com/OpenSees/OpenSeesDocumentation/master/source/user/manual/model/elements/SSPbrick.rst
