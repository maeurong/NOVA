...
- [StructuralCurveAction](https://www.saf.guide/en/stable/loads/structuralcurveaction.html) and [StructuralCurveMoment](https://www.saf.guide/en/stable/loads/structuralcurvemoment.html)
...
- [StructuralEdgeConnection](https://www.saf.guide/en/stable/supports-and-hinges/structuraledgeconnection.html)
...
- [Project and model specification](https://www.saf.guide/en/stable/getting-started/project-and-model-specifications/README.html)
...
- [StructuralCurveMember](https://www.saf.guide/en/stable/structural-analysis-elements/structuralcurvemember.html) and [StructuralCurveMemberRib](https://www.saf.guide/en/stable/structural-analysis-elements/structuralcurvememberrib.html)
	- “Begin node” and “End node” properties removed
- [StructuralPointSupport](https://www.saf.guide/en/stable/supports-and-hinges/structuralpointsupport.html)
...
- [ResultInternalForce2DEdge](https://www.saf.guide/en/stable/results/resultinternalforce2dedge.html)
	- result object for internal forces on edges of 2D members
- [StructuralPointSupportDeformation](https://www.saf.guide/en/stable/loads/structuralpointsupportdeformation.html)
...
- [StructuralCurveActionFree](https://www.saf.guide/en/stable/loads/structuralcurveactionfree.html)
	- “Value 2”: required only if Direction = X, Y or Z **and** Distribution = Trapez
		- “Vector 2”: required only if Direction = Vector **and** Distribution = Trapez
- [StructuralCurveMoment](https://www.saf.guide/en/stable/loads/structuralcurvemoment.html)
	- “Value 2”: required only if Distribution = Trapez
- [RelConnectsRigidLink](https://www.saf.guide/en/stable/supports-and-hinges/relconnectsrigidlink.html)
	- “Hinge position”: enum definition clarified

**New object added:**

- [ResultInternalForce1D](https://www.saf.guide/en/stable/results/resultinternalforce1d.html) - result object for internal forces on 1D members
